...
namespace HandmadeDyson
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        {
            Log = Logger;
            Logger.LogInfo($"{PluginInfo.PLUGIN_NAME} v{PluginInfo.PLUGIN_VERSION} — Manual Icarus construction on orbital megastructures");
    ...
    {
        public const string PLUGIN_GUID = "com.paulspooner.dsp.handmadedyson";
        public const string PLUGIN_NAME = "HandmadeDyson";
