...
namespace DysonWeapons
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        {
            Log = Logger;
            Logger.LogInfo($"{PluginInfo.PLUGIN_NAME} v{PluginInfo.PLUGIN_VERSION} — Particle accelerators, transmutation, and orbital beams");
    ...
    {
        public const string PLUGIN_GUID = "com.paulspooner.dsp.dysonweapons";
        public const string PLUGIN_NAME = "DysonWeapons";
