...
namespace ZeroGProduction
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        {
            Log = Logger;
            Logger.LogInfo($"{PluginInfo.PLUGIN_NAME} v{PluginInfo.PLUGIN_VERSION} — 0G refineries and assemblers with orbital production bonuses");
    ...
    {
        public const string PLUGIN_GUID = "com.paulspooner.dsp.zerogproduction";
        public const string PLUGIN_NAME = "ZeroGProduction";
