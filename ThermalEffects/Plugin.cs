...
namespace ThermalEffects
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        {
            Log = Logger;
            Logger.LogInfo($"{PluginInfo.PLUGIN_NAME} v{PluginInfo.PLUGIN_VERSION} — Planet thermal specialization for refineries and assemblers");
    ...
    {
        public const string PLUGIN_GUID = "com.paulspooner.dsp.thermaleffects";
        public const string PLUGIN_NAME = "ThermalEffects";
