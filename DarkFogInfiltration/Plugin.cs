...
namespace DarkFogInfiltration
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        {
            Log = Logger;
            Logger.LogInfo($"{PluginInfo.PLUGIN_NAME} v{PluginInfo.PLUGIN_VERSION} — Hack and convert Dark Fog assets");
    ...
    {
        public const string PLUGIN_GUID = "com.paulspooner.dsp.darkfoginfiltration";
        public const string PLUGIN_NAME = "DarkFogInfiltration";
