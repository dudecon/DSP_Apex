...
namespace ExoticStars
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        {
            Log = Logger;
            Logger.LogInfo($"{PluginInfo.PLUGIN_NAME} v{PluginInfo.PLUGIN_VERSION} — X-class exotic stars and orbital telescope discovery");
    ...
    {
        public const string PLUGIN_GUID = "com.paulspooner.dsp.exoticstars";
        public const string PLUGIN_NAME = "ExoticStars";
