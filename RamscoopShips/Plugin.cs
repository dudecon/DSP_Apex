...
namespace RamscoopShips
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        {
            Log = Logger;
            Logger.LogInfo($"{PluginInfo.PLUGIN_NAME} v{PluginInfo.PLUGIN_VERSION} — Trade speed for transit harvest quantity");
    ...
    {
        public const string PLUGIN_GUID = "com.paulspooner.dsp.ramscoopships";
        public const string PLUGIN_NAME = "RamscoopShips";
