...
namespace RingworldsOrganic
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        {
            Log = Logger;
            Logger.LogInfo($"{PluginInfo.PLUGIN_NAME} v{PluginInfo.PLUGIN_VERSION} — Organic ringworld biomass maximization");
    ...
    {
        public const string PLUGIN_GUID = "com.paulspooner.dsp.ringworldsorganic";
        public const string PLUGIN_NAME = "RingworldsOrganic";
