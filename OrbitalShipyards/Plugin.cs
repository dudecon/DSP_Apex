...
namespace OrbitalShipyards
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        {
            Log = Logger;
            Logger.LogInfo($"{PluginInfo.PLUGIN_NAME} v{PluginInfo.PLUGIN_VERSION} — Satellite launchers and sphere component mass production");
    ...
    {
        public const string PLUGIN_GUID = "com.paulspooner.dsp.orbitalshipyards";
        public const string PLUGIN_NAME = "OrbitalShipyards";
