...
namespace TerraformingReGreening
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        {
            Log = Logger;
            Logger.LogInfo($"{PluginInfo.PLUGIN_NAME} v{PluginInfo.PLUGIN_VERSION} — Expanded flora and organic megastructures");
    ...
    {
        public const string PLUGIN_GUID = "com.paulspooner.dsp.terraformingregreening";
        public const string PLUGIN_NAME = "TerraformingReGreening";
