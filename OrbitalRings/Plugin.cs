...
namespace OrbitalRings
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        {
            Log = Logger;
            Logger.LogInfo($"{PluginInfo.PLUGIN_NAME} v{PluginInfo.PLUGIN_VERSION} — Buildable planetary rings/swarms with relay and harvest effects");
    ...
    {
        public const string PLUGIN_GUID = "com.paulspooner.dsp.orbitalrings";
        public const string PLUGIN_NAME = "OrbitalRings";
