...
namespace SystemMover
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        {
            Log = Logger;
            Logger.LogInfo($"{PluginInfo.PLUGIN_NAME} v{PluginInfo.PLUGIN_VERSION} — Relocate star systems and planets using warp energy");
    ...
    {
        public const string PLUGIN_GUID = "com.paulspooner.dsp.systemmover";
        public const string PLUGIN_NAME = "SystemMover";
