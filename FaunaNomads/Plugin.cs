...
namespace FaunaNomads
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        {
            Log = Logger;
            Logger.LogInfo($"{PluginInfo.PLUGIN_NAME} v{PluginInfo.PLUGIN_VERSION} — Robot animals and nomadic herder playstyle");
    ...
    {
        public const string PLUGIN_GUID = "com.paulspooner.dsp.faunonomads";
        public const string PLUGIN_NAME = "FaunaNomads";
