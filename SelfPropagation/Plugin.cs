...
namespace SelfPropagation
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        {
            Log = Logger;
            Logger.LogInfo($"{PluginInfo.PLUGIN_NAME} v{PluginInfo.PLUGIN_VERSION} — Autonomous sub-agents expanding infrastructure");
    ...
    {
        public const string PLUGIN_GUID = "com.paulspooner.dsp.selfpropagation";
        public const string PLUGIN_NAME = "SelfPropagation";
