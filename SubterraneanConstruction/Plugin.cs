...
namespace SubterraneanConstruction
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        {
            Log = Logger;
            Logger.LogInfo($"{PluginInfo.PLUGIN_NAME} v{PluginInfo.PLUGIN_VERSION} — Deep mantle mines and layered ecumenopolis");
    ...
    {
        public const string PLUGIN_GUID = "com.paulspooner.dsp.subterraneanconstruction";
        public const string PLUGIN_NAME = "SubterraneanConstruction";
